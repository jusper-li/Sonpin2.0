...
const toneStyles: Record<ProductPageTone, ToneStyle> = {
  luxury: {
    frame: 'bg-gradient-to-b from-[var(--sonpin-surface)] via-[var(--sonpin-background)] to-white border-[var(--sonpin-primary-border)]',
    section: 'bg-white/90 border-[var(--sonpin-primary-border)]',
    title: 'text-[var(--sonpin-ink)]',
    body: 'text-stone-600',
    overline: 'text-[var(--sonpin-primary-soft)]',
    badge: 'bg-[var(--sonpin-primary-border)] text-[var(--sonpin-primary)] border-[var(--sonpin-primary-border)]',
    bullet: 'bg-[var(--sonpin-primary)]',
    button: 'bg-[var(--sonpin-ink)] text-white hover:bg-[var(--sonpin-primary)]',
    divider: 'bg-[var(--sonpin-primary-border)]',
    glow: 'from-[var(--sonpin-primary-strong)]/45 via-[var(--sonpin-primary-strong)]/20 to-transparent',
    chip: 'bg-[var(--sonpin-ink)]/60 text-white border-white/25',
